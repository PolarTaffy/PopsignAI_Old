...
public class RemainLine : MonoBehaviour {
	...
	void Start () {
		...
		if(UnityEngine.Camera.main.orthographicSize == 5) transform.position = Vector3.zero + Vector3.up*5.8f;
		else if(UnityEngine.Camera.main.orthographicSize == 6) transform.position = Vector3.zero + Vector3.up*6.7f;
