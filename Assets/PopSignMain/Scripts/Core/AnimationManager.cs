...
public class AnimationManager : MonoBehaviour
{
    ...
    public void CloseMenu()
    {
        ...
        if( SceneManager.GetActiveScene().name == "game" || SceneManager.GetActiveScene().name == "popsign_regular")
        {
    ...
    public void Play()
    {
        ...
        else if(gameObject.name == "MenuComplete")
        {
            LogPlayTime ();
            CustomizeLevelManager.switchOff();
            SceneManager.LoadScene( "map" );
        ...
        else if( gameObject.name == "PracticeScreen" || gameObject.name == "MenuInGamePause" || gameObject.name == "Settings" || gameObject.name == "MenuGameControl")
        {
            ...
            else
            {
                if(GamePlay.Instance.isPopSignAI)
                    ...
                    SceneManager.LoadScene("popsign_regular");
                VideoManager.resetVideoManager();
            }
        ...
        else if( gameObject.name == "NextLevel")
        {
            ...
            {
                CustomizeLevelManager.reset();
                GamePlay.Instance.isPopSignAI = !GamePlay.Instance.isPopSignAI;
                SceneManager.LoadScene("wordlist");
            }
            else
            {
